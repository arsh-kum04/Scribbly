...
class MainActivity : AppCompatActivity() {
    ...
    var mImageButtonCurrentPaintColors: ImageButton? = null
    var customDialogProgress : Dialog? = null
            ...
            permissions.entries.forEach{
              ...
              val isGranted  = it.value
                ...
                if(isGranted){
                    Toast.makeText(
                        this@MainActivity,
                        "Permission granted now you can storage files.",
                        Toast.LENGTH_LONG
                    ).show()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mImageButtonCurrentPaintColors = linearLayoutPaintColors[1] as ImageButton
        ...
        ib_save.setOnClickListener {
            ...
            if(isReadStorageAllowed()){
                customDialogProgressFun()
                lifecycleScope.launch{
                    val fl_drawingView: FrameLayout = findViewById(R.id.fl_drawingView)
    ...
    private fun requestStoragePermission() {
        if(ActivityCompat.shouldShowRequestPermissionRationale(
            ...
            "needs to Acess Your External Storage")
        }else{
    ...
    private fun customDialogProgressFun(){
        customDialogProgress = Dialog(this)
        customDialogProgress?.setContentView(R.layout.custom_dialog_progress)
